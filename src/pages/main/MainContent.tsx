...
import {
  Box, Text, Flex, Button, HStack, useBreakpointValue,
  ...
  return (
    <Box as="section">
      ...
      <Flex
        ...
        mb={5}
      >
        <Text as="h1" textStyle="h1">Подписки</Text>
  ...
  return (
    <Box as="section">
      ...
      <Flex
        ...
        mb={5}
      >
        <Text as="h1" textStyle="h1">Статистика</Text>
        <HStack mt={{ base: 2, md: 0 }} w={{ base: "full", md: "auto" }}>
          <Button
            leftIcon={<FiPlus />}
            bg="black"
      ...
      <Flex justify="space-between" align="center" mb={3}>
        <Text as="h2" textStyle="h2">Распределение расходов</Text>
        <Text textStyle="p" color="gray.500">1 авг 2025 — 1 сен 2025</Text>
      </Flex>
      <Box mb={5}>
      ...
      {/* Ближайшие списания */}
      <Flex justify="space-between" align="center" mb={3}>
        <Text as="h2" textStyle="h2">Ближайшие списания</Text>
...
export default function MainContent() {
  ...
  const tab = useAppSelector(selectActiveTab); // "subs" | "stats"
