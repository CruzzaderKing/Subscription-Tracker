...
import {
  Avatar, Box, Flex, Button, Container, FormControl, FormLabel,
  Input, InputGroup, InputRightElement, Text, useToast,
...
import { setActiveTab } from "../../store/uiSlice"; // TabKey = "subs" | "stats"
...
export default function RegisterPage() {
  ...
  return (
    <Box minH="100dvh" display="flex" alignItems="center" justifyContent="center" py={{ base: 8, md: 16 }} px={{ base: 4, sm: 6 }}>
      <Container maxW="container.sm" p={0}>
        <Box as="form" onSubmit={handleSubmit} w="full" maxW={{ base: "100%" }} mx="auto" borderWidth="1px" borderRadius="xl" p={{ base: 5 }} bg="chakra-body-bg">
          <Flex direction="column" gap={4} align="center" justify="center" w="100%">
            ...
            <Flex direction="column" gap={1} align="center" justify="center" w="100%">
              ...
              <Text as="h3" textStyle="h3">Трекер подписок и платежей</Text>
            </Flex>

            <Flex direction="column" gap={1} justify="center" w="100%">
              <Text as="h1" textStyle="h1" textAlign="center">Регистрация</Text>
